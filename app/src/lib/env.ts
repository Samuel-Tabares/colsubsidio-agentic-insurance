...
const envSchema = z.object({
  ...
  // Cerebro (repo de Jhon): stub (demo local) | external (HTTP) | vocero (LLM nativo).
  CEREBRO_MODE: z.enum(["stub", "external", "vocero"]).default("vocero"),
  CEREBRO_URL: z.string().url().optional(),
