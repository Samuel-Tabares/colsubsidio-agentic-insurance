...
// Colsubsidio: azul institucional como acento del admin (el amarillo #ffd000 no
// da contraste con texto blanco). El nombre encabeza el chrome y el metadata.
export const DEFAULT_BRANDING: Branding = { name: "Colsubsidio", accent: "#0067b1" };
