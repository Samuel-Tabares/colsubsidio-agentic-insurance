  ...
  head: () => ({
    meta: [
      ...
      { title: "Asesor de Seguros con IA — Colsubsidio" },
      {
        name: "description",
        content:
          "Encuentra el seguro que sí necesitas con nuestro asesor conversacional. Sin letra menuda, sin vendedores insistentes, sin tecnicismos.",
      },
      { name: "author", content: "Colsubsidio" },
